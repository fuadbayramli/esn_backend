...
@section('content')
    <div class="container-fluid" id="up-position">
                                    ...
                                    <div class="panel-body no-padding-left-right">
                                        <div class="col-md-10 no-padding-left-right">
                                            ...
                                            @elseif($setting->type == "markdown_editor")
                                                <textarea class="form-control easymde"
                                                          name="{{ $setting->key }}">{{ $setting->value ?? '' }}</textarea>
    ...
    @endcan
    <div class="up-button">
        <a href="#up-position"><i class="icon voyager-double-up" aria-hidden="true"></i></a>
    </div>
...
@section('javascript')
    ...
    <script type="text/javascript">
        ...
        $(".group_select_new").select2({
            ...
            width: 'resolve',
            placeholder: '
            {{ __("voyager::generic.select_group") }}'
        })
        $(".group_select_new").val('').trigger('change');
    </script>
    <div style="display:none">
        <input type="hidden" id="upload_url" value="
{{ route('voyager.upload') }}">
